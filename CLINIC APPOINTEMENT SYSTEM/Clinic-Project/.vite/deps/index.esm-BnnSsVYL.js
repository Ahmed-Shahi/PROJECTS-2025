...
//#endregion
export { Component, ComponentContainer, DEFAULT_ENTRY_NAME, Deferred, ErrorFactory, FirebaseError, LogLevel, Logger, Provider, SDK_VERSION, Sha1, _addComponent, _addOrOverwriteComponent, _apps, _clearComponents, _components, _getProvider, _isFirebaseApp, _isFirebaseServerApp, _isFirebaseServerAppSettings, _registerComponent, _removeServiceInstance, _serverApps, assert, assertionError, base64, base64Decode, base64Encode, contains, createMockUserToken, createSubscribe, deepCopy, deepEqual, deleteApp, errorPrefix, extractQuerystring, getApp, getApps, getDefaultEmulatorHost, getDefaultEmulatorHostnameAndPort, getExperimentalSetting, getModularInstance, getUA, initializeApp, initializeServerApp, isAdmin, isBrowserExtension, isCloudWorkstation, isCloudflareWorker, isEmpty, isIE, isMobileCordova, isNodeSdk, isReactNative, isValidFormat, jsonEval, map, onLog, pingServer, querystring, querystringDecode, registerVersion, safeGet, setLogLevel$1 as setLogLevel, stringLength, stringToByteArray, stringify, updateEmulatorBanner };
//# sourceMappingURL=index.esm-BnnSsVYL.js.map